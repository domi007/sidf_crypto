# SIDF Crypto
# Created by Domonkos P. Tomcsanyi
#
# Heavily influenced by https://github.com/free5gc/util_3gpp/blob/main/suci/toSupi.go (Thank you!)
#
...
# HashBackend for Python Cryptography <= 3.0
backend = default_backend()

## CONSTANTS
# mode:
#  - testing: in case you are testing
#  - network: in case you are on the network side (deconcealing)
#  - ue: in case you are on the UE side (concealing)
...
if mode == "testing":
  ...
  print("Unknown mode word, exiting.")
  sys.exit(1)
...
def profileA_conceal(SUPI):
  ...
  # ephemeral key pair generated initially from the elliptic curve + the stored HomeNW public key
...
def toSUCI(SUPI="00012080f6", profile="A"):
  SUPI = unhexlify(SUPI)
  print("INCOMPLETE SUCI IMPLEMENTATION, CURRENTLY ONLY RETURNING SCHEME OUTPUT!!")
  return profileA_conceal(SUPI)
  # INCOMPLETE, this is currently returning the schemeOutput instead of a full SUCI, which is:
